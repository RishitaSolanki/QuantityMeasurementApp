        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstValue = table.Column<double>(type: "float", precision: 18, scale: 2, nullable: false),
                    FirstUnit = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    SecondValue = table.Column<double>(type: "float", precision: 18, scale: 2, nullable: false),
                    SecondUnit = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Operation = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Result = table.Column<double>(type: "float", precision: 18, scale: 2, nullable: false),
                    ...
                    ResultString = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JwtTokenId = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "GETUTCDATE()"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSessions_JwtTokenId",
                table: "UserSessions",
                column: "JwtTokenId",
                unique: true);
